...
| Member | Sprint 4 focus |
|---|---|
| Victor | Notifications, privacy/security, implementation support |
| Marco | Notification tests and budget edge cases |
| Eloi | Usability testing and feedback synthesis |
| Biel | Documentation and presentation structure |
| Dani | Presentation assets and product explanation |

## Definition Of Done

A Sprint 4 item is done when:

- the implementation or document is committed,
- related tests pass locally,
- GitHub Actions passes,
- documentation explains how to verify the work,
- the Kanban status is updated.

## Risks

| Risk | Mitigation |
|---|---|
| AI recommendations may be too large for the sprint | Keep MVP scope with advanced rules or document future AI integration. |
| Notifications may affect several app views | Start with simple in-app budget notifications. |
| Kanban and repository may diverge | Update the board after each merged task. |
| Usability testing may be left too late | Prepare the script at the start of Sprint 4. |
